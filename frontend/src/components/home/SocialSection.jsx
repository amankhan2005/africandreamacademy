...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/people/African-Dream-Academy-Foundation/61551525420397/",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/africandreamacademyfoundation",
    icon: (
      ...
      <div style={{ padding: "96px 2rem" }}>
        ...
        <div style={{
          ...
          >
            ...
            >
              Connect with us and stay up-to-date with what's new in African
              Dream Academy.
            </motion.p>
              ...
              {socials.map(({ label, href, icon }) => (
                <motion.a
                  ...
                  onMouseLeave={e => {
                    ...
                    e.currentTarget.style.color = P.crimson;
                  }}
                >
                  {icon}
                  {label}
